...
class RecipeMapper {
  ...
  }) => maps.map((Map<String, Object?> map) => fromMap(map, defaultCategory: defaultCategory)).toList();
  ...
  static List<Map<String, Object?>> toMapList(List<Recipe> recipes) => recipes.map(toMap).toList();
}
