...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({
    ...
    required final List<UserRecipe> userRecipes,
  ...
  final List<UserRecipe> _userRecipes;
  @override
  List<UserRecipe> get userRecipes {
    if (_userRecipes is EqualUnmodifiableListView) return _userRecipes;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_userRecipes);
  }
  ...
  @override
  String toString() {
    return 'ProfileState.loaded(preferences: $preferences, stats: $stats, badges: $badges, userRecipes: $userRecipes, favoritesCount: $favoritesCount)';
  }
  ...
  int get hashCode => Object.hash(
    ...
    const DeepCollectionEquality().hash(_userRecipes),
    favoritesCount,
  );
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(preferences, stats, badges, userRecipes, favoritesCount);
  }
...
abstract class _Loaded implements ProfileState {
  const factory _Loaded({
    required final PromptPreferences preferences,
  ...
  PromptPreferences get preferences;
